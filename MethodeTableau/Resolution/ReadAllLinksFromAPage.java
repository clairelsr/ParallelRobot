...
import ExctractingCharacters.LirePage;
...
public class ReadAllLinksFromAPage extends Thread{
	
	ConcurrentHashMap<String,Integer> characters; 
	...
	public ReadAllLinksFromAPage(ConcurrentHashMap<String,Integer> characters, // NEED TO FIND THE PROPER THREAD-SAFE STRUCTURE
	ConcurrentHashMap<String,Integer> finalresults,
	String father,
	int generation,
	LinkedBlockingQueue<String> pageToExplore
		        	...
		        	if(link!=null && finalresults.containsKey(link)){
		            	...
		            	if ((link!=null) && (!(link.startsWith(_url))) && (!(link.startsWith(father))) &&
		                	...
		                	if(pasunedatedate){
		                		...
		                		if(characters.containsKey(link)){
